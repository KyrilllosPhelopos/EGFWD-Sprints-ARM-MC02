...
static const Gpt_ConfigType* LocalConfigPtr = NULL_PTR ; // pointer to the stract of the congigrations 
...
* \Description     : to init the specified timer with the specified configrations                                    
*                                                                             
